  ...
  return (
    <>
      ...
      <div
        className={
          showFront
            ? 'mb-4 border-4 p-6 rounded-sm border-green-300'
      ...
      {cardIndex > 0 && <button onClick={previousCard}>Previous</button>}
      <button className='bg-blue-600 hover:bg-blue-900' onClick={handleFlip}>
        Flip
      </button>
